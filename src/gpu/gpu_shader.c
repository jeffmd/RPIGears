...
static ID_t next_deleted_shader;
...
static ID_t find_shader(const char *vertex_file_name, const char *fragment_file_name)
{
  int id = 1;
...
{
  ID_t id = find_shader(vertex_file_name, fragment_file_name);
  GPUShader *shader;
