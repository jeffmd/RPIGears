OBJS=RPIGears.o matrix_math.o gear.o user_options.o window.o demo_state.o key_input.o tasks.o RPi_Logo256.o
BIN=RPIGears.bin
SRC= shaders.c gles1.c gles2.c scene.c
HDR=user_options.h demo_state.h window.h matrix_math.h gear.h key_input.h tasks.h image.h
...
key_input.o: key_input.c window.h demo_state.h print_info.h
	$(CC) $(CFLAGS) $(INCLUDES) -g -c -o $@ $< -Wno-deprecated-declarations
