...
static void draw_sceneGLES1(void)
{
  ...
  glTranslatef(camera_viewX(), camera_viewY(), camera_viewDist());

  glRotatef(camera_view_rotx(), 1.0, 0.0, 0.0);
  glRotatef(camera_view_roty(), 0.0, 1.0, 0.0);
  glRotatef(camera_view_rotz(), 0.0, 0.0, 1.0);
